...
const mathPlugin: IntegrationPlugin = {
  ...
  actions: [
    ...
    },
    {
      ...
      description:
        "Evaluate N-way agreement across multiple price feeds or oracle readings (e.g. Chronicle, Chainlink, Pyth). BigInt-safe, checks pairwise deviations and computes consensus median.",
      category: "Math",
      ...
      outputFields: [
        ...
        { field: "minSourcesMet", description: "Whether minimum source count requirement was met" },
        { field: "maxDeviation", description: "Maximum difference found between any two sources" },
        { field: "maxPercentDeviation", description: "Maximum percentage difference between any pair" },
        { field: "median", description: "Median value across all consensus sources" },
      ...
      configFields: [
        {
          ...
          helpTip: "Newline-separated, comma-separated, or JSON array of values from multiple oracle/read nodes.",
          rows: 4,
        },
        {
          key: "tolerance",
        ...
        },
        {
          ...
          min: 2,
          defaultValue: "2",
          helpTip: "Fails if fewer than this number of sources are supplied (prevents single-oracle fallback).",
        },
        {
          key: "precision",
          label: "Percent Decimal Places",
