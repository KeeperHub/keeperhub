 ...
 *
 * Discovered plugins: blockscout, code, data, discord, elizaos, evm-chain, hyperliquid, math, pagerduty, protocol, robinhood, safe, sendgrid, slack, telegram, tempo, web3, webhook
 */
