 ...
 *
 * Generated types: aave-v3, aave-v4, aerodrome, ai-gateway, ajna, blockscout, chainlink, chronicle, clerk, code, compound, cowswap, curve, database, discord, elizaos, ethena, ether-fi, evm-chain, frax-ether-v2, hyperliquid, layerzero, lido, linear, math, morpho, pendle, protocol, pyth, resend, robinhood, rocket-pool, safe, sendgrid, sky, slack, spark, superfluid, telegram, tempo, uniswap, v0, web3, webflow, webhook, wrapped, yearn
 */
