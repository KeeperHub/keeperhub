/**
 * Default blockchain chains and explorer seed data
 *
...
import type { NewChain, NewExplorerConfig } from "../../lib/db/schema";
import {
  CHAIN_CONFIG,
  getConfigValue,
  getPrivateRpcUrl,
...
export const chainToDefaultIdMap: Record<string, number> = {
  "Ethereum Mainnet": 1,
...
export function getExplorerConfigs(): NewExplorerConfig[] {
  return DEFAULT_CHAINS.map((chain) => {
