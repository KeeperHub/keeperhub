...
| `matchesRegex` | matches regex | Pattern | Left operand matches the regex pattern in the right operand. The pattern must be a quoted string, not a reference |
